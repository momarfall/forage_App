      ...
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container box_1620">
         ...
         {{--  <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            ...
            <a class="button button-outline button-small" href="/laravelApp/public/login">Login</a>
            <a class="button button-outline button-small" href="/laravelApp/public/register">Register</a>
            <a class="button button-outline button-small" href="/laravelApp/public/loginfor">Profile</a>
  ...
  <section class="hero-banner text-center">
    <div class="container">
     {{--  <p class="text-uppercase">Smart Company With perfect space</p> --}}
      <h1><i>BIENVENUE A SENFORAGE</h1></i>
      <h3><i><p class="hero-subtitle">Une Entreprise évoluant dans la production et la distribution d’Eau pour les Villageois du Nord du Sénégal</p></h3></i>
      <a class="button button-outline" href="/laravelApp/public/test">Get Started</a>
    </div>
  </section>
  <!--================ Banner Section end =================-->
    ...
    <div class="container">
      ...
      <div class="owl-carousel owl-theme logo-carousel">
        <div class="logo-carousel-item">
          <img class="img-fluid" src="img/home/brand-logo1.png" alt="">
        </div>
        <div class="logo-carousel-item">
          <img class="img-fluid" src="img/home/brand-logo2.png" alt="">
        </div>
        <div class="logo-carousel-item">
          <img class="img-fluid" src="img/home/brand-logo3.png" alt="">
        </div>
        <div class="logo-carousel-item">
          <img class="img-fluid" src="img/home/brand-logo4.png" alt="">
        </div>
        <div class="logo-carousel-item">
          <img class="img-fluid" src="img/home/brand-logo5.png" alt="">
        </div>
      </div>
    </div>
  </section> --}}
